...
class Go2wPiper(LeggedRobot):
    ...
    def _post_physics_step_callback(self):
        ...
        if self.cfg.commands.heading_command:
            ...
            self.commands[:, 2] = torch.clip(3.0 * wrap_to_pi(self.commands[:, 3] - heading), -1., 1.)
    ...
    def update_command_curriculum(self, env_ids):
        ...
        if torch.mean(self.episode_sums["tracking_lin_vel"][env_ids]) / self.max_episode_length > 0.8 * self.leg_reward_scales["tracking_lin_vel"]:
